...
// Require.js allows us to configure shortcut alias
    require.config({
        ...
        , paths: {
            ...
            'dashboardView' : '../app/views/dashboard/dashboardView',
            'dashboardViewConfig' : '../app/views/dashboard/dashboardViewConfig',
            'dashboardViewModel' : '../app/views/dashboard/dashboardViewModel',
