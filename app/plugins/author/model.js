define(['grasshopperModel', 'resources', 'grasshopperCollection', 'constants', 'userDetail/model'], function (GrasshopperModel, resources, GrasshopperCollection, constants, userDetailViewModel) {
    'use strict';
