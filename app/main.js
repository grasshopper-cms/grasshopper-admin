...
require.config({
    ...
    paths : {
        ...
        createFolderView : 'views/createFolder/createFolderView',
        createFolderViewConfig : 'views/createFolder/createFolderViewConfig',
        ...
        createFolderViewModel : 'models/viewModels/createFolderViewModel',
